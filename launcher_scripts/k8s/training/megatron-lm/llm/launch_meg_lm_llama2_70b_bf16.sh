...
CMD="export PYTHONPYCACHEPREFIX=/tmp-pycache/.pycache && python -m compileall /opt/NeMo && \
     python -m compileall /opt/megatron-lm/ && python -m compileall /opt/apex/ && sync && \
     ...
     bash ${DEEP_LEARNING_EXAMPLES_DIR}/training/Megatron-LM/llm/llama/run_${MODEL}.sh" \
